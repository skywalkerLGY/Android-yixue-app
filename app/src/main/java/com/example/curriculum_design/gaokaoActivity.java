...
public class gaokaoActivity extends AppCompatActivity {
    ImageView img_gaokao,img_zhuanye,img_zixun,img_zhiyuan,img_chengji,dakaikaoyan;
    ...
    private int[] resId = {R.drawable.gaokao_ad2, R.drawable.gaokao_ad3, R.drawable.gaokao_ad4};
...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        img_gaokao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent it=new Intent(gaokaoActivity.this,YuanxiaoActivity.class);
                startActivity(it);
            }
        });
        ...
        img_zhuanye.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it=new Intent(gaokaoActivity.this,ZhuanyeActivity.class);
                startActivity(it);
            }
        });
        ...
        img_zixun.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it=new Intent(gaokaoActivity.this,ZixunActivity.class);
                startActivity(it);
            }
        });
        ...
        img_zhiyuan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it=new Intent(gaokaoActivity.this,zhiyuanActivity.class);
                startActivity(it);
            }
        });
        ...
        img_chengji.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it=new Intent(gaokaoActivity.this,chengjiActivity.class);
                startActivity(it);
            }
        });
        dakaikaoyan=(ImageView)findViewById(R.id.dakaigaokao);
        dakaikaoyan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it=new Intent(gaokaoActivity.this,opengaokaowebActivity.class);
                startActivity(it);
            }
        });
        web_gaokaopage=findViewById(R.id.gaokaopage_webview);
        web_gaokaopage.getSettings().setJavaScriptEnabled(true);
        web_gaokaopage.loadUrl("http://m.gaosan.com/zhaosheng/\n");

        ///////////////////////////////高考页面课程课程滑动//////////////////////////////
        dot1 = findViewById(R.id.gaokao_dot_1);
        dot2 = findViewById(R.id.gaokao_dot_2);
        views = new ArrayList<>();
        views.add(LayoutInflater.from(gaokaoActivity.this).inflate(R.layout.gaokaolayout1_1, null));
        views.add(LayoutInflater.from(gaokaoActivity.this).inflate(R.layout.layout1_2, null));
        viewPager = findViewById(R.id.gaokao_viewPager);
        pagerAdapter = new MyPagerAdapter(views, gaokaoActivity.this);
    ...
    void Image_Scroll() {
        myGestureListener = new MyGestureListener(gaokaoActivity.this, viewimage);
        gestureDetector = new GestureDetector(gaokaoActivity.this, myGestureListener);
        for (int i = 0; i < resId.length; i++) {
            //在往viewFlipper中加入imageView
            ImageView img = new ImageView(gaokaoActivity.this);
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (event.getX() - startX > 100) {
                            viewimage.setInAnimation(gaokaoActivity.this, R.anim.left_in);
                            viewimage.setOutAnimation(gaokaoActivity.this, R.anim.left_out);
                            viewimage.showNext();
                        }
                        //向左滑动
                        if (startX - event.getX() > 100) {
                            viewimage.setInAnimation(gaokaoActivity.this, R.anim.right_in);
                            viewimage.setOutAnimation(gaokaoActivity.this, R.anim.right_out);
