...
public class PublicNoticeView2 extends LinearLayout {
    ...
    public PublicNoticeView2(Context context) {
        super(context);
        mContext = context;
        init();
    }

    public PublicNoticeView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
    ...
    protected void bindNotices() {
        ...
        while (i < 5) {
            ...
            i++;
            String text2 = "我国研究生招生规模10年增长近一倍";
